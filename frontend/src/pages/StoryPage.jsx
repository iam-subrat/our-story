        ...
        {renamingTitle ? (
          <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="flex gap-2">
              <button onClick={handleRenameTitle} className="btn-primary px-5 py-2.5">Save</button>
              <button onClick={() => setRenamingTitle(false)} className="btn-soft px-5 py-2.5">Cancel</button>
            </div>
          </div>
        ) : (
            ...
            {isOwner && (
              <>
                <button
                  id="rename-story-btn"
                  title="Rename story"
                  onClick={() => { setTitleDraft(story.title); setRenamingTitle(true); setConfirmDelete(false); }}
          ...
          <div className="mt-3 flex flex-col gap-3 rounded-2xl border border-red-200 bg-red-50 p-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2 flex-shrink-0">
              <button
                ...
                className="btn bg-red-600 text-white hover:bg-red-700 px-5 py-2 text-sm"
              >
                Yes, delete
              </button>
              <button
